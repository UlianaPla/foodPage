...
function openModal(modalSelector, modalTimerId) {
  var modal = document.querySelector(modalSelector); // 1. Вариант через css классы

  modal.classList.add('show');
  modal.classList.remove('hide'); // 2. Вариант через toggle
...
function closeModal(modalSelector) {
  var modal = document.querySelector(modalSelector); // 1. Вариант

  modal.classList.add('hide');
  modal.classList.remove('show'); // 2. Вариант
  //modal.classList.toggle('show');
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  modal.addEventListener('click', function (e) {
    if (e.target === modal || e.target.getAttribute('data-close') == '') {
      // именно modal, не modal__dialog, то закрываем
...
function slider(_ref) {
  ...
  for (var i = 0; i < slidesCount; i++) {
    var dot = document.createElement('li'); //li - list item
  ...
  currentSpan.innerHTML = (0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(slideInd);
  maxSpan.innerHTML = (0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(slidesCount);
  var slideWidthNum = +width.replace(/[a-zA-Z]/g, ''); // преобразует строку '500px' в число 500

  var getOffsetBySlide = function getOffsetBySlide(slideInd) {
    return slideWidthNum * slideInd;
  };
  ...
  function showSlide(slideNum) {
    ...
    currentSpan.innerHTML = (0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(slideNum);
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  tabsParent.addEventListener('click', function (event) {
    ...
    if (target && target.classList.contains(tabsSelector.slice(1))) {
      // slice из строки-селектора вырежет точку вначале. Получится название класса.
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.tabheader__item', '.tabcontent', '.tabheader', 'tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-modal]', '.modal', modalTimerId);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2022-05-20');
